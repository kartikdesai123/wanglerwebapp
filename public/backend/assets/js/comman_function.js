...
//            Toastr.init('warning', 'Some fields are missing!.', '');
        ...
        highlight: function (element) { // hightlight error inputs
            $(element)
                    .closest('.form-group').addClass('is-invalid'); // set error class to the control group
        },
        unhighlight: function (element) { // revert the change done by hightlight
            $(element)
                    .closest('.form-group').removeClass('is-invalid'); // set error class to the control group
        },
        success: function (label) {
            label
                    .closest('.form-group').removeClass('is-invalid'); // set success class to the control group
        },
        messages: messages,
        submitHandler: function (form) {
            if (typeof submitCallback !== 'undefined' && typeof submitCallback == 'function') {
